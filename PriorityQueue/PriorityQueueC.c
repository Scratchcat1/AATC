...
#define __PYX_HAVE__PriorityQueue__PriorityQueueC
#define __PYX_HAVE_API__PriorityQueue__PriorityQueueC
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'PriorityQueue.PriorityQueueC' */
static PyObject *__pyx_f_13PriorityQueue_14PriorityQueueC_BinarySearch(PyObject *, PyObject *); /*proto*/
#define __Pyx_MODULE_NAME "PriorityQueue.PriorityQueueC"
int __pyx_module_is_main_PriorityQueue__PriorityQueueC = 0;

/* Implementation of 'PriorityQueue.PriorityQueueC' */
...
static const char __pyx_k_PriorityQueue_put[] = "PriorityQueue.put";
static const char __pyx_k_PriorityQueueC_pyx[] = "PriorityQueueC.pyx";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_PriorityQueue___init[] = "PriorityQueue.__init__";
static const char __pyx_k_PriorityQueue_remove[] = "PriorityQueue.remove";
static const char __pyx_k_Item_not_in_priority_queue[] = "Item not in priority queue";
static const char __pyx_k_PriorityQueue_PriorityQueueC[] = "PriorityQueue.PriorityQueueC";
static PyObject *__pyx_kp_s_Item_not_in_priority_queue;
static PyObject *__pyx_n_s_PriorityQueue;
static PyObject *__pyx_kp_s_PriorityQueueC_pyx;
...
static PyObject *__pyx_n_s_PriorityQueue_remove;
...
static PyObject *__pyx_pf_13PriorityQueue_14PriorityQueueC_13PriorityQueue___init__(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_13PriorityQueue_14PriorityQueueC_13PriorityQueue_2put(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_item); /* proto */
static PyObject *__pyx_pf_13PriorityQueue_14PriorityQueueC_13PriorityQueue_4pop(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_13PriorityQueue_14PriorityQueueC_13PriorityQueue_6remove(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_item); /* proto */
...
/* "PriorityQueue/PriorityQueueC.pyx":5
 * 
 * class PriorityQueue:
 *     def __init__(self):             # <<<<<<<<<<<<<<
 *         self._Queue = []
...
static PyObject *__pyx_pf_13PriorityQueue_14PriorityQueueC_13PriorityQueue___init__(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self) {
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":6
 * class PriorityQueue:
 *     def __init__(self):
 *         self._Queue = []             # <<<<<<<<<<<<<<
 * 
...
/* "PriorityQueue/PriorityQueueC.pyx":8
 *         self._Queue = []
 * 
 *     def put(self,item):             # <<<<<<<<<<<<<<
 *         cdef int index
...
static PyObject *__pyx_pf_13PriorityQueue_14PriorityQueueC_13PriorityQueue_2put(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_item) {
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":11
 *         cdef int index
 * ##        print(self.Queue,  "<--" , item)
 ...
 */
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":12
 * ##        print(self.Queue,  "<--" , item)
 *         found,index = BinarySearch(self._Queue,item)
 *         if self._Queue != [] and self._Queue[index] < item:             # <<<<<<<<<<<<<<
 *             index +=1
 ...
 */
  ...
  if (__pyx_t_7) {
    ...
    /* "PriorityQueue/PriorityQueueC.pyx":13
 *         found,index = BinarySearch(self._Queue,item)
 *         if self._Queue != [] and self._Queue[index] < item:
 *             index +=1             # <<<<<<<<<<<<<<
 *         self._Queue.insert(index,item)
 ...
 */
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":14
 *         if self._Queue != [] and self._Queue[index] < item:
 *             index +=1
 *         self._Queue.insert(index,item)             # <<<<<<<<<<<<<<
 * ##        print(self.Queue,index)
...
/* "PriorityQueue/PriorityQueueC.pyx":17
 * ##        print(self.Queue,index)
 * 
 *     def pop(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_13PriorityQueue_14PriorityQueueC_13PriorityQueue_4pop(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self) {
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":18
 * 
 *     def pop(self):
 *         return self._Queue.pop(0)             # <<<<<<<<<<<<<<
 * 
...
/* "PriorityQueue/PriorityQueueC.pyx":20
 *         return self._Queue.pop(0)
 * 
 *     def remove(self,item):             # <<<<<<<<<<<<<<
 *         cdef int index
...
static PyObject *__pyx_pf_13PriorityQueue_14PriorityQueueC_13PriorityQueue_6remove(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_item) {
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":22
 *     def remove(self,item):
 *         cdef int index
 *         found,index = BinarySearch(self._Queue,item)             # <<<<<<<<<<<<<<
 *         if found:
 ...
 */
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":23
 *         cdef int index
 *         found,index = BinarySearch(self._Queue,item)
 *         if found:             # <<<<<<<<<<<<<<
 *             self._Queue.pop(index)
 ...
 */
  ...
  if (__pyx_t_7) {
    ...
    /* "PriorityQueue/PriorityQueueC.pyx":24
 *         found,index = BinarySearch(self._Queue,item)
 *         if found:
 *             self._Queue.pop(index)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":26
 *             self._Queue.pop(index)
 *         else:
 *             raise ValueError("Item not in priority queue")             # <<<<<<<<<<<<<<
 * 
...
/* "PriorityQueue/PriorityQueueC.pyx":29
 * 
 * 
...
static PyObject *__pyx_f_13PriorityQueue_14PriorityQueueC_BinarySearch(PyObject *__pyx_v_SearchList, PyObject *__pyx_v_item) {
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":31
 * cdef BinarySearch(list SearchList,item):
 *     cdef int start,end,mid
 *     found = False             # <<<<<<<<<<<<<<
 *     start = 0
 ...
 */
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":32
 *     cdef int start,end,mid
 *     found = False
 *     start = 0             # <<<<<<<<<<<<<<
 *     end = len(SearchList)-1
 ...
 */
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":33
 *     found = False
 *     start = 0
 *     end = len(SearchList)-1             # <<<<<<<<<<<<<<
 *     mid = (start+end)//2
 ...
 */
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":34
 *     start = 0
 *     end = len(SearchList)-1
 *     mid = (start+end)//2             # <<<<<<<<<<<<<<
 *     while not found and start <= end:
 ...
 */
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":35
 *     end = len(SearchList)-1
 *     mid = (start+end)//2
 *     while not found and start <= end:             # <<<<<<<<<<<<<<
 *         mid = (start+end)//2
 ...
 */
  while (1) {
    ...
    /* "PriorityQueue/PriorityQueueC.pyx":36
 *     mid = (start+end)//2
 *     while not found and start <= end:
 *         mid = (start+end)//2             # <<<<<<<<<<<<<<
 *         current = SearchList[mid]
 ...
 */
    ...
    /* "PriorityQueue/PriorityQueueC.pyx":37
 *     while not found and start <= end:
 *         mid = (start+end)//2
 *         current = SearchList[mid]             # <<<<<<<<<<<<<<
 *         if current < item:
 ...
 */
    ...
    /* "PriorityQueue/PriorityQueueC.pyx":38
 *         mid = (start+end)//2
 *         current = SearchList[mid]
 *         if current < item:             # <<<<<<<<<<<<<<
 *             start = mid +1
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "PriorityQueue/PriorityQueueC.pyx":39
 *         current = SearchList[mid]
 *         if current < item:
 *             start = mid +1             # <<<<<<<<<<<<<<
 *         elif current > item:
 ...
 */
    ...
    /* "PriorityQueue/PriorityQueueC.pyx":40
 *         if current < item:
 *             start = mid +1
 *         elif current > item:             # <<<<<<<<<<<<<<
 *             end = mid - 1
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "PriorityQueue/PriorityQueueC.pyx":41
 *             start = mid +1
 *         elif current > item:
 *             end = mid - 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "PriorityQueue/PriorityQueueC.pyx":43
 *             end = mid - 1
 *         else:
 *             found = True             # <<<<<<<<<<<<<<
 * ##        if current  == item:
 ...
 */
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":51
 * ##            end = mid - 1
 * 
 *     return found,mid             # <<<<<<<<<<<<<<
 * 
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_s_Item_not_in_priority_queue, __pyx_k_Item_not_in_priority_queue, sizeof(__pyx_k_Item_not_in_priority_queue), 0, 0, 1, 0},
  {&__pyx_n_s_PriorityQueue, __pyx_k_PriorityQueue, sizeof(__pyx_k_PriorityQueue), 0, 0, 1, 1},
  {&__pyx_kp_s_PriorityQueueC_pyx, __pyx_k_PriorityQueueC_pyx, sizeof(__pyx_k_PriorityQueueC_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_PriorityQueue_remove, __pyx_k_PriorityQueue_remove, sizeof(__pyx_k_PriorityQueue_remove), 0, 0, 1, 1},
 ...
 */
  ...
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(2, 0, 4, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_PriorityQueueC_pyx, __pyx_n_s_remove, 20, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initPriorityQueueC(void); /*proto*/
PyMODINIT_FUNC initPriorityQueueC(void)
#else
PyMODINIT_FUNC PyInit_PriorityQueueC(void); /*proto*/
PyMODINIT_FUNC PyInit_PriorityQueueC(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_PriorityQueueC(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("PriorityQueueC", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_PriorityQueue__PriorityQueueC) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "PriorityQueue.PriorityQueueC")) {
      if (unlikely(PyDict_SetItemString(modules, "PriorityQueue.PriorityQueueC", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":4
 ...
 */
  ...
  /* "PriorityQueue/PriorityQueueC.pyx":1
 * #!python             # <<<<<<<<<<<<<<
 * #cython: boundscheck=False, wraparound=False, infer_types=True,cdivision = True
 * 
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init PriorityQueue.PriorityQueueC", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init PriorityQueue.PriorityQueueC");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
