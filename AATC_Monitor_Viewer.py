...
class Camera:
    ...
    def Draw(self):
        ...
        for DrawObject in self.DrawObjects:
            ...
            if (Object.Coords.x < CameraEndX) or ((Object.Coords.x+Object.Coords.xSize) > self.CameraCoord.x) and \
               (Object.Coords.y < CameraEndY) or ((Object.Coords.y+Object.Coords.ySize) > self.CameraCoord.y ) :  #If DrawObject intersects with Camera , Render, otherwise ignore
                ...
                Object.Make_Image(Object.Coords.xSize*self.CameraZoom ,Object.Coords.ySize*self.CameraZoom) # Object has coordinates and size in these coordinates
...
class Monitor_Sprite(pygame.sprite.Sprite):
    ...
    def Make_CoordsText(self,font):
        self.CoordsText = font.render(str((self.Coords.x,self.Coords.y,self.Coords.z)))

    def Make_Text(self,font):
        self.DrawnText = font.render(self.Text)

    def Make_Type(self,font):
        self.DrawnType = font.render(self.Type)
